/* Pennington Group Associates — site behaviour: theme, header, drawer, reveal, contact form */
(function () {
  'use strict';
  ...
  if (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      var subject = (form.getAttribute('data-subject') || 'Website enquiry') + ' \u2014 ' + (get('company') || get('name') || 'website');
